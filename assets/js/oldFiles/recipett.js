...
//                 document.getElementById('foodChoice').appendChild(imgh2); 
...
//                 img.width = 200;
//                 img.height = 200;
//                 document.getElementById('foodChoice').appendChild(img); 
//             var imga = document.createElement('a');
//                 imga.textContent = data.hits[index].recipe.label;
//                 imga.href = data.hits[index].recipe.url;
//                 document.getElementById('foodChoice').appendChild(imga);
//             var imgul = document.createElement('ul');
//                 imgul.id = "List" + index;
//                 document.getElementById('foodChoice').appendChild(imgul);
//                 //document.getElementById("foodChoice").href = data.hits[index].recipe.url;
//                 for (let i = 0; i < 15; i++) {
...
// };
// //Kick this thing off!
// starvingButton.addEventListener('click', function(event) {
